...
Pod::Spec.new do |s|
  s.name           = 'react-native-camera-mlkit'
  ...
  s.source         = { :git => 'https://github.com/react-native-community/react-native-camera-mlkit', :tag => "v#{s.version}" }
  ...
  s.subspec "TextDetector" do |ss|
    ss.dependency 'react-native-camera-mlkit/RN'
    ss.dependency 'react-native-camera-mlkit/RCT'
